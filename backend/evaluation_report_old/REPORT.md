...
|---|---|---|---|
| **MAE** (Lower is better) | 6.48 | 5.80 | Average points deviation from human score |
| **RMSE** (Lower is better) | 8.24 | 7.41 | Penalizes larger outlier errors more heavily |
| **QWK** (Higher is better) | **0.8410** | **0.8645** | Inter-rater agreement with human ground truth |
